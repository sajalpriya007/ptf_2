...
banner += bcolors.ENDC + """
		    A FRAMEWORK """
banner += bcolors.BOLD + """ FOR ASSESSING """
banner += bcolors.ENDC + """SYSTEM SECURITY\n\n"""

banner += """        		   """ + bcolors.backBlue + \
    """Version: %s""" % (grab_version) + bcolors.ENDC + "\n"

banner += bcolors.YELLOW + bcolors.BOLD + """		        GROUP NO: """ + \
    bcolors.BLUE + """18""" + "\n"

banner += """		GUIDED BY: Dr Pravinkumar M. Kamde         """ + bcolors.ENDC + bcolors.backRed + \
    """  """ + bcolors.ENDC + "\n"

banner += """        	      A project by """ + bcolors.GREEN + bcolors.BOLD + \
    """ Tanishka Mali, Sajal Priya, Onkar Mehetre, Girija Wale """ + bcolors.ENDC + bcolors.BOLD + """ """ + bcolors.ENDC + "\n"

banner += """		 Roll No:  """ + bcolors.BOLD + \
    """ 405C067, 405C054, 405C033, 405B075 """ + bcolors.ENDC + "\n"
banner += """		 """ + bcolors.BOLD + \
    """ """ + bcolors.ENDC + "\n"
banner += """\n                    """ + bcolors.BOLD + """
        """ + bcolors.ENDC
...
banner += """
The Project is under construction, the modules present aren't final. \n"""
